...
(a) Open the file [Ex7_1.sav](/data/Ex7_1.sav) and create a scatter-plot of total lung capacity (TLC) against age. Does the relation look linear to you?
...
The following table shows [resting metabolic rate](https://en.wikipedia.org/wiki/Resting_metabolic_rate) (RMR kcal/24 hr) and body weight (kg) of 44 women (Owen et al, 1986). You can find all data in [Ex7_2.sav](/data/Ex7_2.sav).
...
modelsummary(list(m1, m2), stars = TRUE, gof_omit = "F|Log")
...
modelsummary(list(m1, m2, m3, m4), stars = TRUE, gof_omit = "F|Log")
...
**Answer**: yes, SBP is related to Sex; P < 0.001
